...
public class PigeonApi {
  ...
  public interface Api {
    ...
    @NonNull 
    UserDetails signIn(@NonNull String email, @NonNull String password);
    ...
    static void setUp(@NonNull BinaryMessenger binaryMessenger, @NonNull String messageChannelSuffix, @Nullable Api api) {
      messageChannelSuffix = messageChannelSuffix.isEmpty() ? "" : "." + messageChannelSuffix;
      {
        BasicMessageChannel<Object> channel =
            new BasicMessageChannel<>(
                binaryMessenger, "dev.flutter.pigeon.niral_prj.Api.signIn" + messageChannelSuffix, getCodec());
        if (api != null) {
          channel.setMessageHandler(
              (message, reply) -> {
                ...
                try {
                  UserDetails output = api.signIn(emailArg, passwordArg);
